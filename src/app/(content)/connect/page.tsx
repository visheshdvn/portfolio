      ...
      <main>
        <div className="mt-10">
          ...
          <div className="content-section mb-24 text-white">
            {/* photo section */}
            <div className="flex justify-center 3xl:mb-36 2xl:mb-24 xl:mb-16 lg:mb-24 mb-16">
              <div className="relative 3xl:w-72 3xl:h-72 2xl:w-[272px] 2xl:h-[272px] xl:w-[248px] xl:h-[248px] lg:w-[272px] lg:h-[272px] md:w-[272px] md:h-[272px] flex justify-center items-center">
                ...
                <div className="absolute w-full h-full animate-spin duration-10000">
                  <p className="font-secondary 2xl:text-2xl xl:text-xl font-bold lg:text-2xl md:text-2xl">
                      ...
                      .map((char, i) => {
                        return (
                          <span
                            ...
                            key={i}
                            className="absolute left-1/2 animate-fade 3xl:origin-[0_144px] 2xl:origin-[0_136px] xl:origin-[0_124px] lg:origin-[0_136px] md:origin-[0_136px]"
                          >
                            {char}
                          </span>
                        );
...
function ConnectBtn({ url, text }: { url: string; text: string }) {
  return (
    <Link
      href={url}
      target="_blank"
      className="mx-auto w-[240px] xl:mx-0 connect-btn-shadow 2xl:w-[240px] 2xl:h-[74px] xl:w-[182px] xl:h-14 lg:w-[240px] lg:h-[74px] md:w-[200px] md:h-[62px] border-2 border-[#333] rounded-full"
    >
